  ...
  if cmd_args.load_method == 1:
    ...
    for current_epoch in range(cmd_args.num_epochs):
      ...
      with torch.no_grad():
        ...
        loss_list.append(valid_loss / cnt_batch)
  ...
  # for Kinship / UW-CSE / Cora data
    ...
    for current_epoch in range(cmd_args.num_epochs):
      ...
      with torch.no_grad():
        ...
        loss_list.append(acc_loss/cmd_args.num_batches)
        pre_list.append(auc_pr)
...
if __name__ == '__main__':
  ...
  plt.title('Change of ROC-AUC')
  print(auc_list)
  plt.plot(x2, auc_list, '.-', color='orange')
  plt.savefig('auc.png')
    
  plt.figure(3)
  plt.xlabel('epoch')
  plt.ylabel('Precision score')
  plt.title('Change of Average Precision Score')
  print(auc_list)
  plt.plot(x2, pre_list, '.-', color='purple')
  plt.savefig('pre.png')
